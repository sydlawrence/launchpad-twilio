...
var Launchpad = function(port) {
    ...
    console.log("running launchpad: "+output.getPortName(port));
    ...
    for(var y = 0; y < 9; y++) {
        for(var x = 0; x < 9; x++) {
            ...
            this._grid[x][y] = new Button(that, x, y);
            (function(x,y) {
    ...
    //this.allLight(exports.colors.red.low);
    ...
    for (var j = 0; j < byt.length; j++) {
        switch (byt[j]) {
            case "1":
                ...
                break;
            case "r":
                this._grid[j][i].light(exports.colors.red.high);
                break;
            case "o":
                this._grid[j][i].light(exports.colors.orange.high);
                break;
            case "y":
                this._grid[j][i].light(exports.colors.yellow.high);
                break;
            case "g":
                this._grid[j][i].light(exports.colors.green.high);
                break;
            case "0":
                this._grid[j][i].light(exports.colors.off);
                break;
        }
    }
  }
